...
@section('content')
  <div style="display:flex;flex-direction:column;gap:16px;">
    <div>
      ...
      {{-- Form Create Barang --}}
      <form action="{{ route('barang.store') }}" method="POST" style="display:flex;flex-direction:column;gap:16px;">
        @csrf
        <div>
        ...
        <div style="display: flex; gap: 8px; align-items: center; justify-content: flex-start;">
          ...
          <a href="{{ route('barang.index') }}" style="padding:8px 14px;background-color:var(--primary-hover);color:white;font-size:16px;font-weight:600;border-radius:8px;width:auto;text-decoration:none;display:inline-block;">
            Kembali
          </a>
        </div>
      </form>
